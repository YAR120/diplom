document.addEventListener("DOMContentLoaded", function () {  
    ...
    const setupEventListeners = () => {  
        ...
        if (registrationForm) {
            registrationForm.addEventListener("submit", function (event) {  
                ...
                console.log('Дані для реєстрації:', { username, fullName, email, phone, password });
        ...
        if (loginForm) {
            loginForm.addEventListener("submit", function (event) {  
                ...
                console.log('Дані для авторизації:', { username, password, rememberMe });
    ...
    fetch('header/header1.html')  
        ...
        .catch(error => console.error('Помилка при завантаженні заголовка:', error));  
